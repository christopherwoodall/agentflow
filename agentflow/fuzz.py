...
from agentflow.dsl import fanout_matrix
        ...
        for axis_name, axis_values in extra_axes.items():
            ...
            if normalized_axis in _BUILTIN_MATRIX_AXES:
                raise ValueError(
                    ...
                    "use `include`, `exclude`, or override `derive` instead"
                )
...
__all__ = ["codex_fuzz_campaign_matrix", "codex_fuzz_campaign_preset_names"]
